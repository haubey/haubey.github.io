...
const subtitles = [
    s('2020-04-09', f, 'Back to your regularly scheduled programming'),
    s('2020-04-08', t, 'not sick'),
    s('2020-04-07', t, 'sick'),
    s('2020-04-06', t, 'sick'),
    s('2020-04-05', t, 'sick'),
    s('2020-04-04', t, 'sick'),
    ...
    s('2020-01-26', t, 'So you hear about this thing in China?'),
    s('2020-01-25', f, 'My own personal, less useful Twitter'),
    s('2020-01-24', f, 'no capitalizations today. let\'s be crazy'),
    s('2020-01-23', f, 'Paperback, hardcover, Mac, they\'re all just books'),
    s('2020-01-22', f, 'Warriors, come out to taaaaank'),
    s('2020-01-21', t, 'Gosh what a happy go lucky year'),
    ...
    s('2019-05-12', f, "Brought to you by the letter ü"),
