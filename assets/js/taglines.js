...
const subtitles = [
    s('2020-01-07', false, 'You should get that looked at'),
    s('2020-01-06', false, 'Are you mad at me?'),
    s('2020-01-05', false, 'One...more...to...go...'),
    s('2020-01-04', false, '...and we\'re done for the day'),
    s('2020-01-03', false, 'Curse your sudden but inevitable betrayal!'),
    s('2020-01-02', false, 'Ouch'),
    s('2020-01-01', true, 'Well technically it doesn\'t start for another...'),
    s('2019-12-31', false, 'Beware the surge pricing'),
    s('2019-12-30', false, 'Is Hulu better than Netflix now?'),
    s('2019-12-29', false, 'Almost finished'),
    s('2019-12-28', false, '@ArtDecider'),
    s('2019-12-27', false, 'Patterns for those who pay attention'),
    s('2019-12-26', false, 'S'),
    s('2019-12-25', false, 'Ps'),
    s('2019-12-24', false, 'Ops'),
    s('2019-12-23', false, 'Oops'),
    s('2019-12-22', false, 'Hoops'),
    s('2019-12-21', false, 'Whoops'),
    s('2019-12-20', false, 'Using your computer to harvest bitcoin'),
    s('2019-12-19', false, 'No backsies'),
    s('2019-12-18', false, 'Spider-Man, Spider-Man, does whatever a man can'),
    s('2019-12-17', false, 'Why did I promise to do this?'),
    s('2019-12-16', false, 'The most important thing you\'ll read all year'),
    s('2019-12-15', false, 'Ew'),
    s('2019-12-14', false, 'Live from Spectrum in NYC'),
    s('2019-12-13', false, '0110100001101001'),
    s('2019-12-12', false, 'Taped live'),
    s('2019-12-11', false, 'Bahston'),
    s('2019-12-10', false, 'Objects in mirror are closer than they appear'),
    s('2019-12-09', false, '*Sound on*'),
    s('2019-12-08', false, 'Brought to you by the letter ü'),
    s('2019-12-07', false, '*Computer sounds*'),
    s('2019-12-06', false, 'Your 7 day trial starts now'),
    s('2019-12-05', false, 'Only feed after midnight'),
    s('2019-12-04', false, 'Do not approach'),
    s('2019-12-03', false, 'Guilty Pleasure'),
    s('2019-12-02', false, 'Pshhhhhhhhhhhh (radiator sounds)'),
    s('2019-12-01', false, 'Ding dong'),
    s('2019-11-30', false, '84% Kosher'),
    s('2019-11-29', false, 'You  just missed this tagline'),
    s('2019-11-28', true, 'Turkey time'),
    s('2019-11-27', false, 'Coming soon'),
    s('2019-11-26', false, 'Only available in stores'),
    s('2019-11-25', false, 'Probably asleep'),
    s('2019-11-24', false, 'On sale for a limited time'),
    s('2019-11-23', false, '7% battery'),
    s('2019-11-22', false, 'Award Winning'),
    s('2019-11-21', false, 'Oof'),
    s('2019-11-20', false, 'Hi to the screen readers at home'),
    s('2019-11-19', false, 'Hi to the viewers at home'),
    s('2019-11-18', false, 'Necessary Roughness'),
    s('2019-11-17', false, 'I\'m binge listening to all the music'),
    s('2019-11-16', false, 'Binge all the articles'),
    s('2019-11-15', false, '1st Down'),
    s('2019-11-14', false, 'True Start'),
    s('2019-11-13', false, 'False Start'),
    s('2019-11-12', false, 'I\'m being followed by a sunshadow, sun shadow, sunshadow'),
    s('2019-11-11', false, 'Are you still watching? (Y/n)'),
    s('2019-11-10', false, 'Back to you in the studio'),
    s('2019-11-09', false, 'Incomplete'),
    s('2019-11-08', false, 'Maybe she\'s born with it, maybe it\'s GitHub Pages'),
    s('2019-11-07', false, 'Spaceballs: the website'),
    s('2019-11-06', false, 'It\'s Crunch (bar) time'),
    s('2019-11-05', false, 'The version in Hex is better'),
    s('2019-11-04', false, 'Wait timeout I\'m not ready'),
    s('2019-11-03', false, '/mnt/c/all_your_files'),
    s('2019-11-02', false, 'Battery low, plug in your charger'),
    s('2019-11-01', false, 'Smile for the camera'),
    s('2019-10-31', false, 'Boo!'),
    s('2019-10-30', false, 'You call this a web browser?'),
    s('2019-10-29', false, 'I\'m on your website right now, too'),
    s('2019-10-28', false, 'The race is on'),
    s('2019-10-27', false, 'Who said you could be here?'),
    s('2019-10-26', false, 'The clock is ticking'),
    s('2019-10-25', false, 'Oh, there\'s the challenge flag'),
    s('2019-10-24', false, 'I mean the opposite'),
    s('2019-10-23', false, 'Believe nothing'),
    s('2019-10-22', false, 'The Florida Panthers will give me a heart attack'),
    s('2019-10-21', false, 'Take the sack'),
    s('2019-10-20', false, 'Throw it away'),
    s('2019-10-19', false, 'Did I see you on the subway yesterday?'),
    s('2019-10-18', false, 'T-Mobile by choice, Spectrum by monopoly'),
    s('2019-10-17', false, 'I have Fidelity, but I don\'t see my green line'),
    s('2019-10-16', false, 'Beware the ides of October'),
    s('2019-10-15', false, 'Da da da da da da dun TEQUILA'),
    s('2019-10-14', false, 'This is not normal'),
    s('2019-10-13', false, 'Step into the squared circle, son'),
    s('2019-10-12', false, 'YouTube? More like MeTube, am I right?'),
    s('2019-10-11', false, 'Moving on'),
    s('2019-10-10', false, 'It\'s actually Young Frankenstein\'s Monster'),
    s('2019-10-09', false, 'The website is being served from inside the network!'),
    s('2019-10-08', false, 'Vine died for your sins'),
    s('2019-10-07', false, 'A tradition unlike any other'),
    s('2019-10-06', false, 'This HTML\'s for you'),
    s('2019-10-05', false, 'Boston Scott: An Underdog Story'),
    s('2019-10-04', false, 'Predictions: upredictable'),
    s('2019-10-03', false, 'Time zone dependant'),
    s('2019-10-02', false, 'MLA formatted'),
    s('2019-10-01', false, 'Not that there\'s anything right with that'),
    s('2019-09-30', false, 'That\'s embarrassing, what you just did'),
    s('2019-09-29', false, 'Reachable by smoke signal'),
    s('2019-09-28', false, '(555) 555-5555'),
    s('2019-09-27', false, 'Can you get me a sandwhich?'),
    s('2019-09-26', false, 'This website containes the launch codes'),
    s('2019-09-25', false, 'Insert coins to continue'),
    s('2019-09-24', false, 'Explained better over the phone'),
    s('2019-09-23', false, 'Legally Binding'),
    s('2019-09-22', false, 'Here forever'),
    s('2019-09-21', false, 'Remember to tip your ISP'),
    s('2019-09-20', false, 'Mispelings are on purpose'),
    s('2019-09-19', false, 'How did you even find this page?'),
    s('2019-09-18', false, 'Presented by my brain'),
    s('2019-09-17', false, 'Now in 3D!'),
    s('2019-09-16', false, 'Automatic 10 second runoff'),
    s('2019-09-15', false, 'Reversed'),
    s('2019-09-14', false, 'After review, the ruling on the field is'),
    s('2019-09-13', false, 'Hosted by Ricky Gervais'),
    s('2019-09-12', false, 'Tonight: nothing'),
    s('2019-09-11', false, 'Only hidden fees'),
    s('2019-09-10', false, '#1 Movie in the world'),
    s('2019-09-09', false, '16 minutes could save you 14% off your car insurance'),
    s('2019-09-08', false, 'Wednesday Night Football'),
    s('2019-09-07', false, 'Are you ready for some football?'),
    s('2019-09-06', false, '*Seinfeld theme*'),
    s('2019-09-05', false, 'Unauthorized Access. Authorities Alerted.'),
    s('2019-09-04', false, 'How about that'),
    s('2019-09-03', false, 'What epoch is it?'),
    s('2019-09-02', false, 'What month is it?'),
    s('2019-09-01', false, 'What year is it?'),
    s('2019-08-31', false, 'What day is it?'),
    s('2019-08-30', false, 'Old and made worse'),
    s('2019-08-29', false, 'New and improved'),
    s('2019-08-28', false, 'Can\'t catch a break'),
    s('2019-08-27', false, 'Auric Goldfinger -> Silica Computerberg'),
    s('2019-08-26', false, 'Listen! Do you smell something?'),
    s('2019-08-25', false, 'I left the remote in the other room'),
