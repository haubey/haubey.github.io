...
function f(date, tag, timeSensitive) {
...
const subtitles = [
    f('2021-06-20', `Turns out professional sports players aren't epidemiologists. Who knew?`),
    ...
    f('2021-06-09', `Hi-ho! Max the human here`),
    f('2021-06-08', `Even after all this time, still coming up with easier ways to write these taglines`),
    f('2021-06-07', `I wonder how long is too long for one of these taglines. If this is too long please let me know. I'm not going to check. Thanks for your help.`),
    f('2021-06-06', 'Where did we leave off?'),
    f('2021-06-05', 'From the top'),
    f('2021-06-04', `Apologies to the tagline impaired`),
    f('2021-06-03', `I could be doing literally anything right now`),
    f('2021-06-02', `The new Mac keyboards are better`),
    f('2021-06-01', `<a href="https://nhc.noaa.gov" target="_blank">Happy Hurricane Season</a>`, t),
    f('2021-05-31', `Not feeling it today`),
    f('2021-05-30', `By the power vested in my by the CFAA, you are hereby granted access to this website`),
    f('2021-05-29', 'The New Lucy Dacus is very good, natch', t),
    f('2021-05-28', `Phineas and Ferb holds up. Even Stevens does not.`),
    f('2021-05-27', `I worked on today's tagline extra hard, just for you`),
    f('2021-05-26', `Precise executoin`),
    f('2021-05-25', `On day maybe Seth Meyers' writers will see this and they'll think, "Ok."`),
    f('2021-05-24', `Hello, I'm in Chicago`, t),
    f('2021-05-23', `If I do two of these a day, I'll catch up in 6 months`,t),
    f('2021-05-22', `Float like a MacBook Air, sting like a MacBook Pro`),
    f('2021-05-21', `If it's Sunday, it's Meet the Sleep In`),
    f('2021-05-20', `My dog is looking at me like he doesn't approve what I'm writing`),
    f('2021-05-19', `Are Marine Layer good quality shirts? Lmk`),
    f('2021-05-18', `Ziregolf > PGAMemes > Breakfastballers`),
    f('2021-05-17', `Turning this GitHub into a GitHome`),
    f('2021-05-16', 'Quiet dignity and grace'),
    f('2021-05-15', `A year ago, it was a year ago`, t),
    f('2021-05-14', 'Some of these are quite personal'),
    f('2021-05-13', 'Some of these are quite silly'),
    f('2021-05-12', `TP5 is a decent ball`),
    f('2021-05-11', '*Insert profound musing*'),
    f('2021-05-10', 'Do you know why I pulled you over?'),
    f('2021-05-09', `Do you know how fast you were browsing?`),
    f('2021-05-08', `Sorry, you're banned`),
    f('2021-05-07', `missing ; on line 8 col 27`),
    f('2021-05-06', `*keen observation*`),
    f('2021-05-05', `A sharp wit bloodies the tongue`),
    f('2021-05-04', `Yes, yes, we all know what day it is.`, t),
    f('2021-05-03', 'Duckie is an underrated character'),
    f('2021-05-02', 'Anybody else have trouble watching Breakfast Club?'),
    f('2021-05-01', `Congrats, you're our millionth visiter!`),
    f('2021-04-30', `Thinking of starting an 80s kick`),
    f('2021-04-29', `There are more of a slow burn`),
    f('2021-04-28', `Which goat is GOAT?`),
    f('2021-04-27', `Horsefeathers!`),
    f('2021-04-26', `30 Rock but it's 523 28th St`),
    f('2021-04-25', `Gambling is...fine, I guess`),
    f('2021-04-24', `Pulp Non-Fiction`),
    f('2021-04-23', `Could I pull off a denim jacket? We'll never know`),
    f('2021-04-22', `Adventure Time. That's it, that's the tagline`),
    f('2021-04-21', `I have a feeling that spin rates are going to go down a lot this season`),
    f('2021-04-20', 'Fully vaxxed, time to resume normal life', t),
    f('2021-04-19', 'Florida Panthers are in the playoffs babyyyyyyyyyyy'),
    f('2021-04-18', 'ummmmm...'),
    f('2021-04-17', `Processing...`),
    f('2021-04-16', 'A tweet with 10 likes is like gold'),
    f('2021-04-15', 'Sorry, was in the shower'),
    f('2021-05-14', 'Gonna get real weird with it'),
    f('2021-04-13', 'Heyyyyy Froggy babbbbbyyyyyyy'),
    f('2021-04-12', 'Well, back to work'),
    f('2021-04-11', 'See you next year, friends', t),
    f('2021-04-10', 'What do you think of this one? Good/bad?'),
    f('2021-04-09', 'Boca Midnight = 9pm'),
    f('2021-04-08', 'Hello, friends', t),
    f('2021-04-07', `<a href="https://www.youtube.com/watch?v=5CdrEVoOX4w" target="_blank">On loop all week</a>`),
    f('2021-04-06', 'Mall cops! Henchmen, retreat!'),
    f('2021-04-05', 'Improved tagline experience available on Tagline Premier'),
    f('2021-04-04', 'ESPN: the worldwide leader in future hockey coverage'),
    f('2021-04-03', 'Gritty reboot of Chuck'),
    f('2021-04-02', 'Today is April 2nd', t),
    f('2021-04-01', 'webOS Forever'),
    f('2021-03-31', 'Technology, music, movies, comedy, other stuff maybe'),
    f('2021-03-30', 'South Florida sports apologist'),
    f('2021-03-29', 'Fun fun fun on a Friday night'),
    f('2021-03-28', 'Anybody else missing waking up to a cruise director announcement?'),
    f('2021-03-27', 'The thing about Cobra Kai is that nobody takes karate that seriously'),
    f('2021-03-26', 'This sentence is false'),
    f('2021-03-25', 'Not written from an Athena cluster'),
    f('2021-03-24', 'But now, at the end of my life...',),
    f('2021-03-23', `Why doesn't Amazon do Prime days on days that are prime?`),
    f('2021-03-22', 'I prophesize the Canadiens will make a surprising playoff run',t),
    f('2021-03-21', `"Nice web, Mr. Crack Spider"`),
    f('2021-03-20', `åéîøü and sometimes ¥`),
    f('2021-03-19', `"We got four more of us in the collapsable third row" "Then pity the collapsable third row!"`),
    f('2021-03-18', 'Worldwide leader in things Max Haubenstock'),
    f('2021-03-17', `UTF-8? I'm all about that UTF-16`),
    f('2021-03-16', `"What can only be described as an all out karate riot" hahahaha`),
    f('2021-03-15', `Oh no, it's the ides of March and me with nothing to beware`, t),
    f('2021-03-14', `I'm quite proud of this next tagline`, t),
    f('2021-03-13', `RIP Flash games`),
    f('2021-03-12', `The thing about MacBooks is they're very sharp`),
    f('2021-03-11', 'Bringing niche complaints to the uniwitting masses'),
    f('2021-03-10', 'The word comatose comes from the word coma'),
    f('2021-03-09', 'Unhinged'),
    f('2021-03-08', 'Yahoo Fantasy Football: why every American has a Yahoo email'),
    f('2021-03-07', 'Phasers to stun'),
    f('2021-03-06', 'It is my birthday.', t),
    f('2021-03-05', 'It is the day before my birthday.', t),
    f('2021-03-04', 'Mundaneness'),
    f('2021-03-03', 'Can you find the error in this tagline?'),
    f('2021-03-02', `Help! I'm trapped in a tagline factory!`),
    f('2021-03-01', `I we're rapidly moving towards a vibe-based economy`),
    f('2021-02-28', 'Lamb chops', t),
    f('2021-02-27', `whooooooooooooooooo`),
    f('2021-02-26', 'Whine vs wine'),
    f('2021-02-25', `Spending too much time liking tweets`),
    f('2021-02-24', `Technically this is a string literal`),
    f('2021-02-23', `<a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">Click here</a>`),
    f('2021-02-22', `Back in my day, WiFi was letter based not numbered`),
    f('2021-02-21', `Middle school, my dear Watson`),
    f('2021-02-20', `Sorry I could not make this tageline shorter I didn't have the time`),
    f('2021-02-19', 'Would you like to change religious providers?'),
    f('2021-02-18', `The Dark Knight Begins to Retun to Rise`),
    f('2021-02-17', `This is my 6 beats a day`),
    f('2021-02-16', `No problems have been deteced in the workspace.`),
    f('2021-02-15', "Make $4k a week working from home..."),
    f('2021-02-14', 'Halfway to halfway', t),
    f('2021-02-13', 'ALL CAPS'),
    f('2021-02-12', 'Clean your dryer lint filter.'),
    f('2021-02-11', `I'm tired. Are you tired?`),
    f('2021-02-10', 'Please stop making South Florida a tech bro destination'),
    f('2021-02-09', 'Pure'),
    f('2021-02-08', 'Fat'),
    f('2021-02-07', 'Thin'),
    f('2021-02-06', `*The Entire Vampire Weekend Discography*`),
    f('2021-02-05', `Webflow in the front Airtable in the back is the mullet of webdev`),
    f('2021-02-04', `<a href="https://www.mustardservice.com/" target="_blank">servicio de mostaza</a>`),
    f('2021-02-03', `We are in the Zabka renaissance`),
    f('2021-02-02', `Two Egg McMuffins is the perfect meal for any time of day`),
    f('2021-02-01', `Would like tickets to the Amber Ruffin show`),
    f('2021-01-31', 'Corn off the cob'),
    f('2012-01-30', `Back in Beige`),
    f('2021-01-29', `Kind of incredible how this whole internet thing works, huh?`),
    f('2021-01-28', `Alexa, turn on the website`),
    f('2021-01-27', `Hey Google, turn on the website`),
    f('2021-01-26', `Hey Siri, turn on the website`),
    f('2021-01-25', `Hey Cortana...nevermind`),
    f('2021-01-24', `This is a vim site, if you're an emacs user please leave`),
    f('2021-01-23', `Fun Saturday night 11:10pm`),
    f('2021-01-22', `USB-C is too confusing. Introducing USB-D`),
    f('2021-01-21', 'b, g, n, ac, 6, that makes sense'),
    f('2021-01-20', `What if we gave Esperanto a second look?`),
    f('2021-01-19', 'I come from a long line of grillers'),
    f('2021-01-18', `Surprisingly nobody asks about your AP scores in the real world`),
    f('2021-01-17', `When GitHub removes Pages this will be all for not`),
    f('2021-01-16', `Electric car, coal powered electricity`),
    f('2021-01-15', `I'll take the case!`),
    f('2021-01-14', `Rats!`),
    f('2021-01-13', 'Nuts!'),
    f('2021-01-12', 'Darn!'),
    f('2021-01-11', 'Rafibomb'),
    f('2021-01-10', 'Drugs are better with friends are better with drugs'),
    f('2021-01-09', `No laptop will ever come close to the Dell Latitude D620`),
    f('2021-01-08', `Laser Tag in the strip mall`),
    f('2021-01-07', 'Marking this as a dark day for posterity', t),
    f('2021-01-06', 'The Bulls 90s intro'),
    f('2021-01-05', 'Lucas Bros. Moving Co. is a contemporary masterpiece'),
    f('2021-01-04', 'Going outside for dinner', t),
    f('2021-01-03', 'Typing by looking for each key individually even though I know how to type'),
    f('2021-01-02', 'Oh, I guess not'),
    f('2021-01-01', `So Covid's over now, right?`, t),
